...
module.exports = {
    ...
    if (optionalchoice) {
      await interaction.reply(`You have submitted choices of ${choice1}, ${choice2} and optional choice ${optionalchoice}`);
    } else {
    await interaction.reply(`You have submitted choices of ${choice1}, and ${choice2}!`);
    };
	},
};